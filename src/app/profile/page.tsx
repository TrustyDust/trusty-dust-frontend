...
const profilePosts = [
  ...
  },
  {
    ...
    avatar: "/tier/avatar.png",
    content:
      "Morning coffee and coding. Perfect way to start the day! 🚀☕️",
    likes: 18,
    comments: 5,
    images: [],
  },
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <main className="flex-1 space-y-6">
              ...
              <div className="rounded-[28px] bg-gradient-to-r from-[#04112b] via-[#061c3f] to-[#082356] p-6">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    />
                    <img src="/tier/spark.png" alt="Spark badge" className="absolute -bottom-1 -right-1 h-8 w-8" />
                  </div>
                  <div className="flex-1">
                    <h1 className="text-2xl font-semibold">Walter White</h1>
                    <p className="text-sm text-gray-400">UI/UX Designer</p>
                  </div>
                  <button className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-gray-200 transition hover:bg-white/10">
                    Edit Profile
                  </button>
                </div>
            ...
            {profilePosts.map((post) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <img src={post.avatar} alt={post.author} className="h-12 w-12 rounded-full border border-white/10" />
                  <div>
                ...
                {post.images.length ? (
                  <div className="mt-4 grid grid-cols-4 gap-3">
                    {post.images.map((img) => (
                      <div
                        key={img}
                        className="h-28 rounded-2xl border border-white/5 bg-cover bg-center"
